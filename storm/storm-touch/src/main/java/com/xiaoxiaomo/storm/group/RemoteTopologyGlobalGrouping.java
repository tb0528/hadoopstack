 ...
 *
 */
public class RemoteTopologyGlobalGrouping {
	/**
	...
	public static void main(String[] args) {
		...
		//topologyBuilder.setBolt("bolt_1", new SumBolt()).ShufferGrouping("spout_1");
		topologyBuilder.setBolt("bolt_1", new SumBolt(),3).globalGrouping("spout_1");
		...
		if(args.length==0){
			...
			String simpleName = RemoteTopologyGlobalGrouping.class.getSimpleName();
			try {
				//把topology提交到真正的集群运行
