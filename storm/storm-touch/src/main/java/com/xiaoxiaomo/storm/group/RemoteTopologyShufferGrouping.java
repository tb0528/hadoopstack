 ...
 *
 */
public class RemoteTopologyShufferGrouping {
	/**
	...
	public static void main(String[] args) {
		...
		topologyBuilder.setBolt("bolt_1", new SumBolt(),3).shuffleGrouping("spout_1");
		...
		if(args.length==0){
			...
			String simpleName = RemoteTopologyShufferGrouping.class.getSimpleName();
			try {
				//把topology提交到真正的集群运行
