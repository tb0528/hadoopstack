...
public class RemoteTopology {
	...
	public static void main(String[] args) {
		...
		topologyBuilder.setSpout("spout_1", new MySpout(),2);//在setspout或者setbolt方法中指定并行度的参数
		//通过shuffleGrouping，可以指定bolt接收哪个组件发射出来的数据
		//使用.setNumTasks(5) 预留task，方便后期进行rebalance
		topologyBuilder.setBolt("bolt_1", new SumBolt(),3).setNumTasks(5).shuffleGrouping("spout_1");
